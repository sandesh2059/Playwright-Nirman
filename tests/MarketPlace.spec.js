...
test('Verify working of filter button', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');
...
test('verify search results after changing location in filter', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');  
  ...
  await page.getByRole('link', { name: 'Market', exact: true }).click();
  await page.getByRole('button').filter({ hasText: /^$/ }).click();
  await page.getByRole('dialog', { name: 'Filters' }).click();
...
test('verify search results after changing filer settings to only verified', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');  
  ...
  await page.getByRole('button', { name: 'Apply' }).click();
  await expect(page.locator('.lucide.lucide-badge-check > path').first()).toBeVisible();
  await expect(page.getByRole('heading', { name: 'Jack Sparrow' })).not.toBeVisible();
});

test('Verify search result after changing filter settings of location and minimum rating', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');  
...
test('verify search results after changing filter settings of location and only verified', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');  
...
test('verify search results after changing filter settings of minimum rating and only verified', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');  
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');  
...
test('verify search results after changing filter settings of location, minimum rating and only verified', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');  
...
test('verify working of view profile button', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');
  ...
  await expect(page.getByRole('heading', { name: 'Ram Bahadur Sharma' })).toBeVisible();
});

test('Verify working of view profile button after searching specific profile', async ({page}) => {
  await page.goto('https://dev6.yigserver.com:3000/');
  await page.getByRole('link', { name: 'I already have an account' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).click();
  await page.getByRole('textbox', { name: 'Email address' }).fill('jack16@example.com');  
  ...
  await page.getByRole('link', { name: 'Market', exact: true }).click();
  await page.getByRole('textbox', { name: 'Search by name or skill…' }).click();
  await page.getByRole('textbox', { name: 'Search by name or skill…' }).fill('ram');
  await page.getByRole('link', { name: 'View Profile', first: true }).click();
  await expect(page.getByRole('heading', { name: 'Ram Bahadur Sharma' })).toBeVisible();
});